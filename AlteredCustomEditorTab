# This code is based on Burp's example CustomEditorTab
# hosted at https://portswigger.net/burp/extender/examples/CustomEditorTab.zip.
# Lines commented with "# ADDED LINE" need to be added to your scripts
# if you want prettier stack traces.
...
from exceptions_fix import FixBurpExceptions    # ADDED LINE
